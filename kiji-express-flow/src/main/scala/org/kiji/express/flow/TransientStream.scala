...
class TransientStream[T](genItr: () => Iterator[T]) extends Stream[T] {
  ...
  @transient private var streamCache: WeakReference[Stream[T]] = new WeakReference(null)
  ...
  override def hasDefiniteSize = streamCache.get.isDefined && toStream.hasDefiniteSize
