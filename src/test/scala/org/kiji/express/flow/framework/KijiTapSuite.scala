...
class KijiTapSuite extends KijiSuite {
  ...
  test("KijiTap validates a valid instance/table/column.") {
    ...
    val testScheme: KijiScheme = new KijiScheme(
        ...
        loggingInterval = 1L,
        inputColumns = Map(
            "dummy_field1" -> InputColumnSpec("searches"),
            "dummy_field2" -> InputColumnSpec("family:column1")))
  ...
  test("KijiTap validates a nonexistent column.") {
    ...
    val testScheme: KijiScheme = new KijiScheme(
        ...
        inputColumns = Map(
            "dummy_field1" -> InputColumnSpec("searches"),
            "dummy_field2" -> InputColumnSpec("family:nonexistent")))
  ...
  test("KijiTap validates multiple nonexistent columns.") {
    ...
    val testScheme: KijiScheme = new KijiScheme(
        ...
        loggingInterval = 1L,
        inputColumns = Map(
            "dummy_field1" -> InputColumnSpec("nonexistent1"),
            "dummy_field2" -> InputColumnSpec("family:nonexistent2")))
